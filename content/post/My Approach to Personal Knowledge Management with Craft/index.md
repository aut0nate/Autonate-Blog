...
Craft supports Markdown, keyboard shortcuts, templates, and API access. More recently, Craft introduced support for the [Model Context Protocol (MCP)](https://www.craft.do/imagine), which takes integrations a step further by allowing Craft to connect directly with third-party tools and services.
